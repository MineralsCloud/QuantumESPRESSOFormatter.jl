...
[QuantumESPRESSOFormatter](https://github.com/MineralsCloud/QuantumESPRESSOFormatter.jl).
...
## Install QuantumESPRESSOFormatter
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("QuantumESPRESSOFormatter")
   ```

3. Run

   ```julia-repl
   julia> using QuantumESPRESSOFormatter
   ```
...
version of QuantumESPRESSOFormatter, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/QuantumESPRESSOFormatter.jl"
```

in the second step above.

## Update QuantumESPRESSOFormatter
...
our [GitHub repository](https://github.com/MineralsCloud/QuantumESPRESSOFormatter.jl)
for new releases.
Once we release a new version, you can update QuantumESPRESSOFormatter by typing

```@repl
using Pkg
Pkg.update("QuantumESPRESSOFormatter")
Pkg.gc()
```

in the Julia REPL.

## Uninstall and reinstall QuantumESPRESSOFormatter
...
1. To uninstall, in a Julia session, run
   ...
   julia> Pkg.rm("QuantumESPRESSOFormatter")

   julia> Pkg.gc()
   ```

2. Press `ctrl+d` to quit the current session. Start a new Julia session and
   reinstall QuantumESPRESSOFormatter.
